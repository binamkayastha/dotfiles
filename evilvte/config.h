...
#define COLOR_FOREGROUND       "#cccccc"
//#define    COLOR_STYLE            RXVT/* Options: LINUX, RXVT, TANGO, XTERM, ZENBURN,      */
#define    COLOR_STYLE            LINUX/* Options: LINUX, RXVT, TANGO, XTERM, ZENBURN,      */
